...
namespace DatabaseFirstLINQ
{
    class Problems
    {
        ...
        private void ProblemThree()
        {
            ...
            var price = products.Where(p => p.Price > 150);
        ...
        private void ProblemFour()
        {
            ...
            var products = _context.Products;
            var contains = products.Where(p => p.Name.Contains("s") );

            foreach (Product product in contains)
            {
        ...
        private void ProblemFive()
        {
            ...
            var users = _context.Users;
            var registration = users.Where(p => p.RegistrationDate < DateTime.Parse ("1/1/2016"));
        ...
        private void ProblemSix()
        {
            ...
            var users = _context.Users;
            var registration = users.Where(p => p.RegistrationDate > DateTime.Parse("1/1/2016") && p.RegistrationDate < DateTime.Parse("1/1/2018"));
        ...
        private void ProblemEight()
        {
            ...
            var customerUsers = _context.ShoppingCarts.Include(ur => ur.User).Where(ur => ur.User.Email == "afton@gmail.com").Include(ur => ur.Product);
            foreach (ShoppingCart product in customerUsers)
            {
                Console.WriteLine($"Product Name: {product.Product.Name} {product.Product.Price} {product.Quantity}");
            }
        ...
        private void ProblemTen()
        {
            ...
            var userIds = _context.UserRoles.Include(ur => ur.Role).Include(ur => ur.User).Where(ur => ur.Role.RoleName == "Employee").Select(ur => ur.UserId).ToList();
            var shoppingCartRows = _context.ShoppingCarts.Include(sc => sc.Product).Include(sc => sc.User).Where(sc => userIds.Contains(sc.UserId));

            foreach(ShoppingCart scRow in shoppingCartRows)
            {
                Console.WriteLine($"Email: {scRow.User.Email} Product Name: {scRow.Product.Name} Product Price: {scRow.Product.Price} Quantity: {scRow.Quantity}");
            }
        }
        ...
        private void ProblemSixteen()
        {
            ...
            var product = _context.Products.Where(p => p.Name == "Keurig").SingleOrDefault();
            product.Price = 82m;
